...
<div title='<s:text name="companyFile.title"/>' data-type='form' class="bc-page"
	data-js='js:redactor_css,<s:url value="/bc-business/info/companyFile/formr.js" />'
	data-initMethod='bs.companyFileFormr.init'
	data-option='<s:property value="formPageOption"/>' style="overflow-y:auto;">
	<s:form name="companyFileFormr" theme="simple" style="margin:10px;">
	...
	<div class="info-history" style="text-align:center;font-weight:normal;"><s:text name="companyFile"/> <s:date 
