...
<div title='<s:property value="typeDesc"/>' data-type='form' class="bc-page unselectable" unselectable="on"
	data-js='js:redactor_css' oncontextmenu="return false;"
	...
	<div class="info-subject" style='text-align:center;font-size:30px;outline:0;color:red;' tabIndex="0"><s:if 
	...
	<div class="info-content redactor_editor unselectable" unselectable="on" 
		style='font-weight: normal;'><s:property value="e.content" escapeHtml="false"/></div>
	</s:if>
	<div class="ui-widget-content " style="border-width: 0 0 1px 0;height:1px;"></div>
