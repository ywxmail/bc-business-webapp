...
<div title='<s:property value="typeDesc"/>' data-type='form' class="bc-page unselectable" unselectable="on"
	...
	<div class="info-content redactor_editor unselectable" unselectable="on" style="font-weight: normal;"><s:property value="e.content" escapeHtml="false"/></div>
	</s:if>
	<div class="ui-widget-content " style="border-width: 0 0 1px 0;height:1px;"></div>
