						...
						<tr>
							...
							<td class="value" colspan="3">
								<div class="bc-relativeContainer" style="position : relative; display: inline-block">
									<input type="text" name="e.subject" value='<s:property value="e.subject"/>' style="width:46em;" 
										data-validate="required" class="bc-select ui-widget-content"
										data-maxHeight="150px" 
										data-source='<s:property value="illegalActivityList"/>'/>
									<ul class="inputIcons">
		...
		<div  class="formTable2 ui-widget-content bs-tempDriver-containers"  style="width:710px;">
			...
			<div id="div5" style="border-width:1px 1px 0 0;margin-bottom:8px;">
				<table class="table bc-grid" cellspacing="0" cellpadding="0" style="width:100%;">
					...
					<s:iterator var="wr" value="list_WorkflowModuleRelation">
						<tr class="ui-widget-content row" >
							<td class="first"  style="padding:0 0 0 4px;text-align:left;">
								<a class="bs-case4Business-workFlow-processName" href="#"><s:property value="name"/></a>
					...
					<s:else>
						<tr class="ui-widget-content row" >
							<td colspan="5" class="last" style="padding:0 0 0 4px;text-align:left;">	
								(无权查看流程信息)
							</td>
						</tr>
					</s:else>
