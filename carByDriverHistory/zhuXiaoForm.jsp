						          ...
						          <table class="formFields" cellspacing="2" cellpadding="0" >
									<tr class="widthMarker">
						              ...
						              <tr>
						                 ...
						                 <td class="value" ><s:select name="e.fromClasses" list="classes" headerKey="" headerValue="%{getText('label.please.choose')}" disabled="%{isNewest}"
							              listKey="key" listValue="value" data-validate="required" cssClass="ui-widget-content" disabled="%{!isNewest}"/></td>
							          </tr>
						          </table>
						   </fieldset>
						</td>
