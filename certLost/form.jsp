...
<div title='<s:text name="certLost.title"/>' data-type='form' class="bc-page"
	...
	data-js='<s:url value="/bc/libs/select.js" />,<s:url value="/bc-business/certLost/form.js" />,<s:url value="/bc/identity/identity.js" />,<s:url value="/bc-business/bs.js" />,<s:url value="/ui-libs/xheditor/1.1.7/xheditor-zh-cn.min.js?ts=0" />'
	data-initMethod='bc.certLostForm.init'
	data-option='<s:property value="%{formPageOption}"/>' style="overflow-y:auto;">
	<s:form name="certLostForm" theme="simple">	
		<div style="width:auto">		
					<table class="formFields" cellspacing="2" cellpadding="0" style="width: 850px">
						<tbody>
							...
							<tr>
								...
								<td class="topLabel"  style="width: 40px;min-width: 40px;text-align: left;"><s:text name="certLost.desc"/>:</td>
							</tr>
							<tr>
								...
								<td class="value" rowspan="5" colspan="2"><s:textarea name="e.description" rows="5" cssClass="ui-widget-content noresize" cssStyle="width: 99%;height:100%;"/></td>
							</tr>
							<tr>
					...
					<div class="ui-widget-content" style="border-left-width:0;border-right-width:0;">
						...
						<table class="table" id="certTables" cellspacing="0" cellpadding="0" style="width: 100%;">
							<tr class="ui-state-default header row">
								<td class="first" style="width: 15px;height: 20px;">&nbsp;</td>
								<td class="middle" style="width: 160px;">证件名称</td>
								<td class="middle" style="width: 80px;">证件号码</td>
								<td class="middle" style="width: 80px;">补办原因</td>
								<td class="middle" style="width: 60px;">残骸</td>
								<td class="middle" style="width: 80px;">补办结果</td>
								<td class="middle" style="width: 100px;">补办日期</td>
								<td class="middle" style="width: 80px;">新证件号码</td>
								<td class="middle" style="width: 80px;">遗失地点</td>
								<td class="last">备注</td>
							</tr>
							<s:if test="%{e.isNew()}">
							<tr class="ui-widget-content row" data-id='<s:property value="id"/>'>
								...
								<td class="middle" style="padding:0;text-align:left;">
									<div class="bc-relativeContainer" style="width: 160px;">
