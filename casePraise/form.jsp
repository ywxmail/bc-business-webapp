				...
				<table class="formFields" cellspacing="2" cellpadding="0" >
					<tbody>
						...
						<tr>
							...
							<td class="value">
								<s:select name="e.extent" list="typeList" listKey="value" listValue="value" headerKey="" headerValue="" cssClass="ui-widget-content"></s:select>
							</td>
						...
						<tr>
							...
							<td class="value">
								<s:textfield name="e.rewardMoney" value="%{getText('bs.format.number',{e.rewardMoney})}" cssClass="ui-widget-content"/>
							</td>
