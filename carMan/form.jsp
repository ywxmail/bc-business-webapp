		...
		<div id="formTabs" class="formTabs bc-tabs layout-top ui-widget ui-helper-reset"
	        ...
	        <div class="tabsContainer">
                ...
                <ul class="tabs ui-helper-reset">
					...
					<li class="tab ui-widget-content"><a href='<s:url value="/bc-businsess/contract/list" />' class="ui-state-default">保险</a></li>
					...
					<li class="tab ui-widget-content"><a href='<s:url value="/bc-businsess/contract/list" />' class="ui-state-default">违法违章</a></li>
					<li class="tab ui-widget-content"><a href='<s:url value="/bc-businsess/contract/list" />' class="ui-state-default">表扬与投诉</a></li>
					<li class="tab ui-widget-content"><a href='<s:url value="/bc-businsess/contract/list" />' class="ui-state-default">迁移历史</a></li>
					<li class="tab ui-widget-content"><a href='<s:url value="/bc-businsess/contract/list" />' class="ui-state-default">安全学习</a></li>
