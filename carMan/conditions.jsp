			...
			<div class="value">
				<div class="bc-dateContainer">
					...
					<div class="value checkboxes"  data-condition='{"type":"int","key":"m.classes"}' >
						...
						<label><input type="checkbox" name="checkboxField1" value="3,4"><span>替班</span></label>
						<label><input type="checkbox" name="checkboxField1" value="5,6"><span>公共替班</span></label>
