...
<div title='<s:text name="invoice4Refund.title"/>' data-type='form' class="bc-page"
	data-saveUrl='<s:url value="/bc-business/invoice4Refund/save" />'
	data-js='<s:url value="/bc-business/invoice/refund/form.js" />,<s:url value="/bc/identity/identity.js" />,<s:url value="/bc-business/bs.js" />'
	data-initMethod='bs.invoice4RefundForm.init'
	data-option='<s:property value="%{formPageOption}"/>' style="overflow:auto;">
	<s:form name="invoice4RefundForm" theme="simple">
		<div class="formFields ui-widget-content"  style="width:750px;">
					...
					<tr>
						...
						<td class="value relative">
							<s:textfield name="e.carPlate" cssClass="bc-select ui-widget-content" readonly="false" 
								...
								data-cfg='{"strict":true,"delay":100,"minLength":2, "labelMapping":"{{plateType}}.{{plateNo}}", "valueMapping":"{{id}}","itemMapping":"TPL.BS.CAR_SELECT_ITEM","callback":"bs.invoice4RefundForm.afterSelectCar"}'
						...
						<td class="label">*<s:text name="invoice4Refund.refundDate"/>:</td>
						<td class="value relative">
			...
			<div class="ui-widget-content" style="border-width:1px 0 0 0;margin-bottom:8px;">
				<div class="ui-widget-header" style="position:relative;border-width: 0;padding: 0.25em;">
					<span class="text"><s:text name="invoice4Refund.detail"/>:</span>
					<ul class="inputIcons">
