	...
	<ul class="conditions" style="min-width:19.3em;">
		<li class="condition">
			<div class="bc-relativeContainer">
				...
				<div class="value checkboxes" data-condition='{"type":"string","key":"t.company"}' style="width: 9em;">
		...
		<li class="condition">
			<div class="bc-relativeContainer">
				...
				<div class="value bc-relativeContainer ">
					<input type="text" class="bc-select ui-widget-content" style="width: 9em;" 
						data-condition='{"type":"long","ql":"t.year_=?"}'
						data-validate='{"required":false,"type":"digits","max":9999,"min":1000,msg:"年份必须在1000～9999之间！"}'>
				</div>
			</div><div style="width:12px;display:inline-block;"></div><div class="bc-relativeContainer">
				<div class="label">月份</div>
				<div class="value bc-relativeContainer">
					<input type="text" class="bc-select ui-widget-content" style="width: 9em;" 
						data-condition='{"type":"long","ql":"t.month_=?"}'
						data-validate='{"required":false,"type":"digits","max":12,"min":1,msg:"月份必须在1～12之间！"}'>
				</div>
			</div>
		</li>
	</ul>
