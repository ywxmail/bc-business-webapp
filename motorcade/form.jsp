...
<div title='<s:text name="createMotorcade.title"/>-<s:property value="e.name" />' data-type='form' class="bc-page"
    data-js='<s:url value=" /bc-business/motorcade/form.js" />,<s:url value="/bc/identity/identity.js" />'
			...
			<table class="formFields" cellspacing="2" cellpadding="0">
				<tbody>
					...
					<tr>
						...
						<td class="value"><s:property value='<s:date format="yyyy-MM-dd" name="e.modifiedDate" />' /><s:text name="motorcade.changeName"/>:
