	...
	<ul class="conditions" style="min-width:19.3em;">
		<li class="condition">
			...
			<div class="value">
				...
				<input type="hidden" data-condition='{"type":"string","ql":"t.unit_name=?"}'>
				<ul class="inputIcons">
		...
		<li class="condition">
			...
			<div class="value">
				<input type="text" class="bc-select ui-widget-content" readonly="readonly"
					...
					data-condition='{"type":"string","ql":"t.motorcade_name=?"}'>
				<ul class="inputIcons">
					<li class="bc-select inputIcon ui-icon ui-icon-triangle-1-s" title='<s:text name="title.click2select"/>'></li>
					<li class="clearSelect inputIcon ui-icon ui-icon-close" title='<s:text name="title.click2clear"/>'></li>
				</ul>
			...
			<div class="value">
				<div class="bc-dateContainer">
					<input type="text" class="bc-date ui-widget-content" data-validate="date" style="width:9em;"
						data-condition='{"type":"startDate","ql":"t.happen_date>=?"}'>
					<ul class="inputIcons">
					...
					<input type="text" class="bc-date ui-widget-content" data-validate="date" style="width:9em;"
						data-condition='{"type":"endDate","ql":"t.happen_date<=?"}'>
					<ul class="inputIcons">
						<li class="selectCalendar inputIcon ui-icon ui-icon-calendar"></li>
						<li class="clearSelect inputIcon ui-icon ui-icon-close" title='<s:text name="title.click2clear"/>'></li>
					</ul>
